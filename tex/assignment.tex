...
This exercise has been heavily based on teaching material provided by Prof. Thierry Van Cutsem\footnote{\url{https://thierryvancutsem.github.io/}}.

\subsection{Grading and deliverables}

\begin{enumerate}
	\item This assignment counts for 10\% of the final grade.
	\item You must use stepss \footnote{\url{https://stepss.sps-lab.org/python/}} and the online platform of the lab\footnote{\url{https://sps.cut.ac.cy/jhub}}. You can use the example exercise\footnote{\url{https://sps.cut.ac.cy/jhub-5-bus}} as the starting point.
...
\begin{itemize}
	...
	\item Reactive power entering line 1-3: 	
