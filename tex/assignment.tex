...
\begin{enumerate}
	...
	\item You must use PyRAMSES \footnote{\url{https://stepss.sps-lab.org/pyramses/}} and the online platform of the lab\footnote{\url{https://sps.cut.ac.cy/jhub}}. You can use the example exercise\footnote{\url{https://sps.cut.ac.cy/jhub-5-bus}} as the starting point.
